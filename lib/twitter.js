...
function formatDeploymentTweet(deploymentData) {
  ...
  const manifestTxId = deploymentData.manifestTxId || deploymentData.txId || 'N/A';
  ...
  if (deploymentData.success && manifestTxId !== 'N/A') {
    tweet += `🔗 [View Deployment](https://arweave.net/raw/${manifestTxId})\n`;
  }
